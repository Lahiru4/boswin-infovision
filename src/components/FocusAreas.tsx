...
const focusAreas = [
  { title: "FINTECH", icon: <BadgePercent className="w-12 h-12 text-red-500 mb-4" /> },
  { title: "Education", icon: <GraduationCap className="w-12 h-12 text-boswin-blue mb-4" /> },
  { title: "Healthcare", icon: <Heart className="w-12 h-12 text-red-500 mb-4" /> },
  { title: "Agriculture", icon: <Leaf className="w-12 h-12 text-boswin-blue mb-4" /> },
  { title: "Manufacturing", icon: <Factory className="w-12 h-12 text-red-500 mb-4" /> },
  { title: "Export", icon: <Ship className="w-12 h-12 text-boswin-blue mb-4" /> },
  { title: "Trading", icon: <Briefcase className="w-12 h-12 text-red-500 mb-4" /> },
  { title: "Consumer & Retail", icon: <Store className="w-12 h-12 text-boswin-blue mb-4" /> },
  { title: "Food Products", icon: <Utensils className="w-12 h-12 text-red-500 mb-4" /> },
  { title: "Industrial Solutions", icon: <Wrench className="w-12 h-12 text-boswin-blue mb-4" /> },
  { title: "Power & Energy", icon: <Zap className="w-12 h-12 text-red-500 mb-4" /> },
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-12">
          {focusAreas.map((area, index) => (
            <div 
              key={index} 
              className="focus-card group hover:border-l-4 hover:border-red-300"
            >
